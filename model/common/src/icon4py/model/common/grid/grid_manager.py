...
def _construct_diamond_vertices(
    ...
    if apply_torus_permutation:
        ...
        sorted_e2c2v = e2c2v[sort_idx]
        n_edges = sorted_e2c2v.shape[0]
        grouped_idx = array_ns.concatenate(
            (
                array_ns.arange(0, n_edges, 3, dtype=gtx.int32),
                array_ns.arange(1, n_edges, 3, dtype=gtx.int32),
                array_ns.arange(2, n_edges, 3, dtype=gtx.int32),
            )
        )
        return sorted_e2c2v[grouped_idx]
